define((require, exports, module) => {
  ...
  const logger = store => dispatch => (action, data) => {
    ...
    if (action=="ROBOT_CHANGE_TARGET"){
      parent.document.getElementById("showPosX").innerHTML = "";
      parent.document.getElementById("showPosX").innerHTML = "X="+JSON.stringify(data["position"]["x"]);
      parent.document.getElementById("showPosY").innerHTML = "";
      parent.document.getElementById("showPosY").innerHTML = "Y="+JSON.stringify(data["position"]["y"]);
      parent.document.getElementById("showPosZ").innerHTML = "";
      parent.document.getElementById("showPosZ").innerHTML = "Z="+JSON.stringify(data["position"]["z"]);
          parent.document.getElementById("showRotX").innerHTML = "";
      parent.document.getElementById("showRotX").innerHTML = "X="+JSON.stringify(data["rotation"]["x"]);
      parent.document.getElementById("showRotY").innerHTML = "";
      parent.document.getElementById("showRotY").innerHTML = "Y="+JSON.stringify(data["rotation"]["y"]);
      parent.document.getElementById("showRotZ").innerHTML = "";
      parent.document.getElementById("showRotZ").innerHTML = "Z="+JSON.stringify(data["rotation"]["z"]);
    ...
    if (action=="ROBOT_CHANGE_TARGET"){
      parent.document.getElementById("showBound").innerHTML = "";
    if ((JSON.stringify(newState["jointOutOfBound"])).indexOf("true")!=-1){
      parent.document.getElementById("showBound").innerHTML = "";
      parent.document.getElementById("showBound").style.color="red"
      parent.document.getElementById("showBound").innerHTML = "This pose is invalid because one or more joints is out of limits"
      
      
    }
  else{
    parent.document.getElementById("showBound").innerHTML = "";
    parent.document.getElementById("showBound").style.color="green"
    parent.document.getElementById("showBound").innerHTML = "This pose is valid"
  }}
